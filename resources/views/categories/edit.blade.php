          ...
          <div class="card-body">
             <form action="{{ route('categories.update', ['category' => $category]) }}" method="POST">
                ...
                <div class="form-group">
                   ...
                   <input id="input_category_title" value="{{ old('title', $category->title) }}" name="title" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Judul"/>
                    @error('title')
                ...
                <div class="form-group">
                   ...
                   <input id="input_category_slug" value="{{ old('slug', $category->slug) }}" name="slug" type="text" class="form-control @error('slug') is-invalid @enderror" readonly placeholder="Slug"/>
                   @error('slug')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                   ...
                   <div class="input-group">
                      ...
                      <input id="input_category_thumbnail" name="thumbnail" value="{{ old('thumbnail', asset($category->thumbnail)) }}" type="text" class="form-control @error('thumbnail') is-invalid @enderror" placeholder="Thumbnail" readonly />
                      @error('thumbnail')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                   ...
                   <select id="select_category_parent" name="parent_category" data-placeholder="Pilih Category" class="custom-select w-100">
                    @if (old('parent_category', $category->parent()))
                        <option value="{{ old('parent_category', $category->parent->id ?? null) }}" selected>
                            {{ old('parent_category', $category->parent->title ?? null) }}
                        </option>
                    @endif
                   </select>
                </div>
                ...
                <div class="form-group">
                   ...
                   <textarea id="input_category_description" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi" rows="3">{{ old('description', $category->description) }}</textarea>
                   @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
