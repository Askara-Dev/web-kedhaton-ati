                ...
                <div class="row d-flex align-items-stretch">
                   <div class="col-md-8">
                      ...
                      <div class="form-group">
                         ...
                         <input id="input_post_slug" value="{{ old('slug', $post->slug) }}" name="slug" type="text" class="form-control @error('slug') is-invalid @enderror" placeholder="slug"
                            readonly />
                            @error('slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                      ...
                      <div class="form-group">
                         ...
                         <textarea id="input_post_description" name="description" placeholder="deskripsi" class="form-control @error('description') is-invalid @enderror"
                      ...
                      <div class="form-group">
                         ...
                         <textarea id="input_post_content" name="content" placeholder="konten" class="form-control @error('content') is-invalid @enderror"
                ...
                <div class="row">
                   <div class="col-md-12">
                      ...
                      <div class="form-group">
                         ...
                         <select id="select_post_tag" name="tag[]" data-placeholder="masukkan tag" class="custom-select w-100 @error('tag') is-invalid @enderror"
                            multiple>
